...
@pytest.mark.case_id('EX-003')
@scenario('features/standard_requests.feature', 'Basic Exchange Rate Retrieval with invalid api key')
def test_exchange_rate_retrieval_invalid_creds():
    pass
